<template>
  <div class="bg-slate-50 dark:bg-gray-900 rounded-lg shadow-md shadow-orange-200 dark:border-4 dark:border-orange-500  rounded-xl p-8 w-full max-w-md backdrop-blur-md">
    ...
    <input type="text" v-model="longUrl" placeholder="https://example.com"
      ...
      dark:border-gray-600 dark:text-white text-orange-500 dark:placeholder-orange-400  placeholder-sky-300 ">
    ...
    <p id="result" class="mt-4 text-center font-medium text-sky-700 dark:text-orange-300" v-html="result"></p>
  </div>
</template>
